...
function RegisterSystem() {
  ...
  const handleRegister = async () => {
    try {
      ...
      const response = await axios.post(`http://127.0.0.1:8000/create_user/?email=${email}&password=${password}`, {});
        ...
        <MDBCol md='5' className='position-relative'>
          ...
          <MDBCard className='my-5 bg-glass'>
            ...
            <h3 className='mb-5 text-center'>Good to see you again</h3>
              ...
              <MDBInput wrapperClass='mb-4' label='Confirm Password' id='form5' type='password' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required/>
            ...
            <MDBBtn className='w-100 mb-4' size='md' onClick={handleRegister}>register</MDBBtn>
