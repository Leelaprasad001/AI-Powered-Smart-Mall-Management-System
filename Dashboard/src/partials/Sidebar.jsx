    ...
    <div>
      ...
      >
        ...
        <div className="space-y-8">
          {/* Pages group */}
          <div>
            <h1 className="text-xs uppercase text-slate-500 font-semibold">
              <span className="hidden lg:block lg:sidebar-expanded:hidden 2xl:hidden text-center w-6" aria-hidden="true">
                •••
              </span>
              <span className="lg:hidden lg:sidebar-expanded:block 5xl:block">Pages</span>
            </h1>
            <ul className="mt-3">
              {/* Dashboard */}
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/dashboard"
                              className={({ isActive }) => 
                                'block transition duration-150 truncate ' + (isActive ? 'text-slate-400' : 'text-indigo-500 hover:text-indigo-500')
                              }
                            >
              ...
              {/* Settings */}
              <SidebarLinkGroup activecondition={pathname === '/' || pathname.includes('settings')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname === '/' || pathname.includes('settings') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              ...
                              <path
                                className={`fill-current ${ pathname === '/' || pathname.includes('settings') ? 'text-indigo-500' : 'text-slate-600'}`}
                                d="M19.714 14.7l-7.007 7.007-1.414-1.414 7.007-7.007c-.195-.4-.298-.84-.3-1.286a3 3 0 113 3 2.969 2.969 0 01-1.286-.3z"
                              />
                              <path
                                className={`fill-current ${ pathname === '/' || pathname.includes('settings') ? 'text-indigo-300' : 'text-slate-400'}`}
